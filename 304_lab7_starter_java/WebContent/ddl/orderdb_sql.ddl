...
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('BogeyMan', 1, '10 boxes x 20 bags',18.00,'');
...
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Banshee',2,'12 - 550 ml bottles',10.00,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Zombie',2,'48 - 6 oz jars',22.00,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Hydra',2,'36 boxes',21.35,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Chimera''s Boysenberry Spread',2,'12 - 8 oz jars',25.00,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Yeti',4,'12 - 1 lb pkgs.',30.00,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Dragon',2,'12 - 12 oz jars',40.00,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Unicorn',5,'18 - 500 g pkgs.',97.00,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Basilisk',6,'12 - 200 ml jars',31.00,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Pheonix',3,'1 kg pkg.',21.00,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Griffin',3,'10 - 500 g pkgs.',38.00,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Werewolf',4,'40 - 100 g pkgs.',23.25,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Satyrs',2,'24 - 250 ml bottles',15.50,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Centaurs',7,'32 - 500 g boxes',17.45,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Minotaur',5,'20 - 1 kg tins',39.00,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Mermaid',6,'16 kg pkg.',62.50,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Gorgon',7,'10 boxes x 12 pieces',9.20,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Goblin',7,'30 gift boxes',81.00,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Fairy',7,'24 pkgs. x 4 pieces',10.00,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Ogre',8,'24 - 500 g pkgs.',21.00,'');
...
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Golems',6,'24 - 250 g  jars',19.00,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Gnomes',6,'24 - 4 oz tins',18.40,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Imp',6,'12 - 12 oz cans',9.65,'');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Wraith',8,'32 - 1 kg pkgs.',14.00,'');
...
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Cat',1,'24 - 12 oz bottles',14.00,'');
...
-- New SQL DDL for lab 8
 UPDATE Product SET productImageURL = 'img/boogey.jpg' WHERE ProductId = 1;
